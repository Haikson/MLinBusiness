...
def predict():
	...
	if flask.request.method == "POST":
		...
		subreddit = request_json.get("subreddit")
		parent_comment = request_json.get("parent_comment")

		logger.info(f'{dt} Data: comment={comment}, subreddit={subreddit}, parent_comment={parent_comment}')
		try:
